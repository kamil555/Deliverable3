...
/**
 * This is the Auction class. This class takes in the 
 * non profits request for an auction.
 * 
 * @author Mindy Huynh
 *
 */
public class Auction
{
	// auction name
	/**
	 * This is the name of the auction, it will be automatically generated
	 * via the the non profits name and the date of the auction.
	 */
	private String auctionName;
	
	/**
	 * This is the date in which the auction start. 
	 * It includes date, month, year as well as hour and minute of the auction start.
	 */
	// auction date
	private Date auctionStart;
	
	/**
	 * This is the date in which the auction end. 
	 * It includes date, month, year as well as hour and minute of the auction end.
	 ...
	 * It will be automatically generated via the auction start and end. 
	 */
	 ...
	 * It requires the non-profit user to fill out
	 * profitName. auctionStartDAte, auctionDuration.
	 * @param nonprofitName The name of the nonprofit company
	 * @param auctionStartDate when the auction starts.
	 * @param auctionDuration	when the auction ends.
	 * @throws ParseException
	 */
	public Auction(String nonprofitName, Date auctionStartDate, int auctionDuration)
			throws ParseException
	{
	...
	/**
	 * This is the method to reset the auction name.
	 * Since the start date or the non profit name may change, I want the auction name to change
	 * according to the new non profit name.
	 * @throws ParseException
	 */
	public void resetAuctionName() throws ParseException
	{
		//"calculating" auction name
		String date = getDate(auctionStart.getMonth(),
				auctionStart.getDay(), auctionStart.getYear());
	 ...
	 * @return auctionStart the time and date of when the auction is scheduled to start.
	 */
	 ...
	 * @param auctionStart the new date and time for when the auction starts.
	 * @throws ParseException 
	 */
	...
	/**
	 * This is the method to reset the auction end.
	 * Since the start date or duration may change, I want the auction end to change
	 * according to the duration and start date.
	 * @throws ParseException
	 */
	 ...
	 * @param auctionDuration the new duration of the auction.
	 */
	 ...
	 * @param profitName the new name of the non profit.
	 * @throws ParseException 
	 */
	 ...
	 * @return the string representation all the information saved in the auction class.
	 */
...
//	}
	 ...
	 * @param month the month we want to change to string
	 * @param day the date we want in the string
	 * @param year the year we want in the string.
	 * @return
	 */
