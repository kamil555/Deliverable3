...
public class AuctionTest
{
	...
	public void test()
	{
		...
		// assertEquals("AuctionName", "Auction-June-2-2015",
		// auction.getAuctionName());
	}
	
	/**
	 * The resetAuctionName method is supposed to be called at every single
	 * change. Testing if the auction name gets reset after non profit name is
	 * changed.
	 * 
	...
	/**
	 * The resetAuctionName method is supposed to be called at every single
	 * change Testing if the auction name gets reset after start date is
	 * changed.
	 * 
	 * @throws ParseException
	 */
