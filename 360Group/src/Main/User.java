...
public class User implements java.io.Serializable{
	 ...
	 * (Postcondition returns Username)
	 */
	 ...
	 * @param userName
	 * (Precondition String passed is not NULL)
	 * (Postcondition replaces the Username)
	 */
	 ...
	 * @return String of what the User is
	 * (Precondition nothing)
	 * (Postcondition returns state of User)
	 */
	 ...
	 * (Postcondition User becomes in right state)
	 */
	 ...
	 * (Precondition User is NonProfit)
	 ...
	 * @param organization
	 * (Precondition String is not Null)
	 * (Postcondition Organization name to the right User)
	 */
